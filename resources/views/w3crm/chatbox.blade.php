    ...
    <div class="custom-tab-1">
        <ul class="nav nav-tabs" role="tablist">
            <li class="nav-item" role="presentation">
                <a class="nav-link active" data-bs-toggle="tab" href="#notes" aria-selected="true" role="tab">Notes</a>
            </li>
            <li class="nav-item" role="presentation">
                <a class="nav-link" data-bs-toggle="tab" href="#alerts" aria-selected="false" tabindex="-1" role="tab">Alerts</a>
            </li>
            <li class="nav-item" role="presentation">
                <a class="nav-link" data-bs-toggle="tab" href="#chat" aria-selected="false" role="tab" tabindex="-1">Chat</a>
            </li>
        </ul>
        <div class="tab-content">
            <div class="tab-pane fade" id="chat" role="tabpanel">
                <div class="card mb-sm-3 mb-md-0 contacts_card dz-chat-user-box d-none">
                ...
                <div class="card chat dz-chat-history-box">
                    ...
                    <div class="card-body msg_card_body dz-scroll" id="DZ_W_Contacts_Body3" style="height: 114px;">
